...
public class RepositoryTest {
    ...
    @Test
    public void givenMovieIdShouldReturnCorrectProduct() {
        Movie savedMovie = movieRepository.save(movie);
        assertEquals(savedMovie.getTitle(), "Ladyhawke");
    }

    @Test
    public void givenIncorrectMovieIdShouldReturnEmpty(){
        movieRepository.save(movie);
        assertEquals(movieRepository.findById(9000), Optional.empty());
    }
    ...
    public void returnCorrectNumberOfSavedDocuments(){
        movieRepository.save(movie);
        assertEquals(movieRepository.count(),712);
    }
}
